        ...
        <footer className="bg-gray-800 text-white py-6">
            <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
                ...
                <div className="flex space-x-4 mt-4 md:mt-0">
                    <Link href="/privacy-policy" className="hover:text-gray-400">Política de Privacidad</Link>
                    <Link href="/terms" className="hover:text-gray-400">Términos y Condiciones</Link>
                    <Link href="/contact" className="hover:text-gray-400">Contacto</Link>
                </div>

                {/* Copyright */}
                <p className="text-sm mt-4 md:mt-0">&copy; {new Date().getFullYear()} MoreMarket. Todos los derechos reservados.</p>
            </div>
        </footer>
    );
};
